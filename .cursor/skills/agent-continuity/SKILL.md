...
**This skill is mandatory for every agent session** — including specialized personas. SESSION is the single source of truth; no agent may skip read at start or update at end.
